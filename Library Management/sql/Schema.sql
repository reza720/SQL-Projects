...
CREATE TABLE Address (
    ...
    INDEX idx_address_province_district_street (province , district , street)
);
...
ALTER TABLE Person
ADD INDEX idx_person_first_last_name (first_name, last_name);
...
CREATE TABLE Book (
    ...
    INDEX idx_book_publisher_id (publisher_id),
    INDEX idx_book_genre_id (genre_id)
);
...
CREATE TABLE Book_Transaction (
    ...
    INDEX idx_book_transaction_member_id (member_id),
    INDEX idx_book_transaction_book_isbn (book_isbn),
    INDEX idx_book_transaction_member_id_is_returned (member_id, is_returned),
    INDEX idx_book_transaction_book_isbn_is_returned (book_isbn, is_returned)
);
...
CREATE TABLE Schedule (
    ...
    FOREIGN KEY (staff_id)
        REFERENCES Staff (id),
    INDEX idx_schedule_staff_id (staff_id)
);
...
CREATE TABLE Log (
    ...
    FOREIGN KEY (staff_id)
        REFERENCES Staff (id),
    INDEX idx_log_staff_id (staff_id)
);
